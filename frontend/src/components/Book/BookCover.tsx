...
export const BookCover: React.FC<BookCoverProps> = ({
  ...
  <div
    className={`group relative w-full h-full aspect-[2/3] rounded-xl overflow-hidden shadow-lg transition-all duration-500 hover:shadow-primary/40 hover:-translate-y-2 bg-gray-100 ${className}`}
  >
    {src ? (
      <img
        src={src}
