...
export const BookCover: React.FC<BookCoverProps> = ({ src, alt, className }) => (
  ...
  >
    ...
    <div className="absolute inset-x-0 bottom-0 translate-y-full p-4 transition-transform duration-300 group-hover:translate-y-0">
      <div className="rounded-lg bg-black/30 backdrop-blur-md border border-white/20 p-2 shadow-sm">
        <h3 className="text-sm font-medium text-white text-center leading-tight">
          {alt}
        </h3>
      </div>
    </div>
